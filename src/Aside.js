    ...
    <div>
      <div className="main_aside">
        ...
        <div className="explore_part">
          ...
          <div className=" aside_part">
                <div className="mini_logo">
                <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24"><g fill="none" fill-rule="evenodd"><path d="M24 0v24H0V0zM12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035c-.01-.004-.019-.001-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427c-.002-.01-.009-.017-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093c.012.004.023 0 .029-.008l.004-.014l-.034-.614c-.003-.012-.01-.02-.02-.022m-.715.002a.023.023 0 0 0-.027.006l-.006.014l-.034.614c0 .012.007.02.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z"/><path fill="currentColor" d="M18.633 9.177L14 10.72v6.78a4.5 4.5 0 1 1-2-3.742V6.442a3 3 0 0 1 2.051-2.846l3.975-1.325A1.5 1.5 0 0 1 20 3.694v3.585a2 2 0 0 1-1.367 1.898m-3.95-3.684L18 4.387V7.28l-4 1.334V6.442a1 1 0 0 1 .684-.95ZM12 17.5a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0"/></g></svg>
                </div>
                <div className="aside_name">
                    <a href="">Music</a>
                </div>
          ...
          <div className=" aside_part">
                <div className="mini_logo">
                <svg xmlns="http://www.w3.org/2000/svg" width="21px" height="23px" viewBox="0 0 24 24"><path fill="currentColor" d="M24 13.2v-6l-6-3.6l-6 3.6l-6-3.6l-6 3.6v6l12 7.2zM8.4 10.8H6v2.4H4.8v-2.4H2.4V9.6h2.4V7.2H6v2.4h2.4zm7.2 2.4a1.2 1.2 0 0 1-1.2-1.2c0-.66.54-1.2 1.2-1.2c.66 0 1.2.54 1.2 1.2c0 .66-.54 1.2-1.2 1.2m3.6-2.4A1.2 1.2 0 0 1 18 9.6c0-.66.54-1.2 1.2-1.2c.66 0 1.2.54 1.2 1.2c0 .66-.54 1.2-1.2 1.2"/></svg>
                </div>
                <div className="aside_name">
                    <a href="">Gaming</a>
                </div>
